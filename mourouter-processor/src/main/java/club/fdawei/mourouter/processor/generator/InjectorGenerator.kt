...
import club.fdawei.mourouter.processor.util.kotlinType
...
class InjectorGenerator(
    ...
    private fun buildInjector(
        ...
        val funBuilder = FunSpec.builder(ClassInfo.Injector.FUN_INJECT)
            ...
            .addParameter(ClassInfo.Injector.FUN_ARG_PROVIDER, TypeBox.AUTOWIRED_PROVIDER)
            .addParameter(ClassInfo.Injector.FUN_ARG_DATA, TypeBox.ACTION_DATA)
